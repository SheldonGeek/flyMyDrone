package com.leilei.alexaflydrone.aws_iot;
...
public class IotDroneSubscriber {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT_PREFIX = "a36g05pk8eeuq0";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-east-1:a00a85dd-b0b7-4c63-b293-8ad6726cf0e6";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "dronePolicy";
    ...
    private static final String CERTIFICATE_ID = "cert_id";
    // The IoT Drone Topic
    private static final String MQTT_DRONE_TOPIC = "$aws/things/FlyADrone/shadow/update";
